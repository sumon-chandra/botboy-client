...
const CategoryCard = () => {
  return (
    <section className="grid-cols-3 gap-5 px-4 py-8 space-y-6 lg:space-y-0 lg:px-72 lg:grid">
      <div className="p-10 rounded-lg cursor-pointer bg-white lg:h-[400px] shadow-lg flex flex-col justify-between">
        <img src={dc} alt="" />
        <div>
      ...
      <div className="flex flex-col justify-between p-10 lg:h-[400px] shadow-lg bg-white rounded-lg cursor-pointer">
